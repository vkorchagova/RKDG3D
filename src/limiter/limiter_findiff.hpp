...
public:
   ...
   /// Constructor 
   LimiterFinDiff(Indicator& _ind, Averager& _avgr, ParFiniteElementSpace *_fes, const Array<int>& _offsets, bool _linearize = 0, bool _haveLastHope = 1, int _d = 3) 
      : Limiter(_ind,_avgr,_fes,_offsets,_linearize,_haveLastHope,_d) {};
