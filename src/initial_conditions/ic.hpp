...
public:
   ...
   double plane(const Vector& x)
   {
       ...
       {
            std::cout << "Wrong dimension inside ICPlaneBreakup" << std::endl;
            exit(1);
       }
   }
...
public:
   ...
   double sphere(const Vector& x)
   {
       ...
       {
            std::cout << "Wrong dimension inside ICSphericalBreakup" << std::endl;
            exit(1);
       }
   }
...
class ICDensityPulse : public IC
{
   ...
   double oneMinusR2(const Vector& x)
   {
       ...
       {
            std::cout << "Wrong dimension inside ICDensityPulse" << std::endl;
            exit(1);
       }
   }
...
public:
   ...
   bool inHexadrons(const Vector& x)
   {
       ...
       {
            std::cout << "Wrong dimension inside ICTwoHexahedronsBreakup" << std::endl;
            exit(1);
       }
   }
