...
public:
   ...
   virtual bool inside_domain(const double* x) override
   {
       ...
       {
            std::cout << "Wrong dimension inside SphericalLocalRefiner" << std::endl;
            exit(1);
       }
   }
};
...
public:
   ...
   virtual bool inside_domain(const double* x) override
   {
       ...
       {
            std::cout << "Wrong dimension inside HexahedronLocalRefiner" << std::endl;
            exit(1);
       }
   }
};
