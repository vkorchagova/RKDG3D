...
// boundaries
Physical Curve("inlet") = {10, 20}; // make 1D patch from lines
Physical Curve("nozzle") = {1, 2, 3, 4, 5, 6, 11, 12, 13, 14, 15, 16};
Physical Curve("left") = {7, 17};
Physical Curve("topBottom") = {8, 18};
Physical Curve("outlet") = {9, 19};
